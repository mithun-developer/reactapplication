...
function Annual() {
  return (
    ...
    >
      <form>
        <center>
          <h3 style={{ fontFamily: "fantasy" }}>Annual Leaves</h3>
          <p>
            You will be entitled to twenty seven (24) days annual leaves for
            every year of service; Leave should be arranged through your
            department manager. You will be entitled to take the public holidays
            as applicable in the state and city of Hyderabad, Telengana and such
